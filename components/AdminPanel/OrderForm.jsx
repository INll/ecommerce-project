              ...
              {isDone
                ? isSuccess  // can either display order details or error message
                  ? <div className='w-[80%]'>
                      ...
                      <ul className='mt-5 mb-10 flex flex-col justify-center items-center h-fit gap-[0.6rem]'>
                      <ul className='pr-4 grid grid-cols-12 w-full h-10 text-center items-center text-lg'>
                        <li className='col-span-3'>預覽圖</li>
                        <li className='col-span-4'>名稱</li>
                        <li className='col-span-1'>類別</li>
                        <li className='col-span-2'>價格</li>
                        <li className='col-span-2'>庫存</li>
                      </ul>
                ...
                : <div className='relative mb-6'>
                    <div className='relative text-center w-full tracking-wider text-xl'>
                      輸入訂單編號
                      <div className='absolute text-center w-full tracking-wider text-sm italic left-[9.5rem] top-2 text-stone-400'>(格式: xxxx-xxxxxx-xxxx)</div>
                    </div>
                    <div className="flex mb-4 justify-center items-center gap-3 w-full h-fit mt-4">
                      ...
                      {(errors.id1 || errors.id2 || errors.id3)
                        ...
                        : null}
                      <div className='pb-2 text-4xl'>-</div>
