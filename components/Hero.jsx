      ...
      <div class="bg-slate-800 sm:flex justify-center">
        <header className='px-20 py-20 sm:px-auto sm:py-auto sm:w-auto flex flex-col sm:flex-col justify-center items-center sm:items-start'>
          ...
          <button className='bg-gradient-to-r from-amber-300 via-amber-100 to-amber-300
            ...
            rounded-[0.2rem] font-extrabold text-[1.55rem] tracking-wider transition-ring ease[cubic-bezier(0.88, 1.09, 0.6, 0.98)] duration-150 ring-0 hover:ring-2 ring-amber-300'>立卽選購</button>
        </header>
